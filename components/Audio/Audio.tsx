    ...
    <div className={classes.box}>
        ...
        <div className={classes.controls}>
            <audio
                ...
                controls
            />
                <IoPlaySkipBack size={24} onClick={() => handlePreviousOrNext('previous')} />
                {props.isPlaying
                    ? <IoPause size={32} onClick={() => handlePause()} />
                    : <IoPlay size={32} onClick={() => handlePlay()} />
                }
                <IoPlaySkipForward size={24} onClick={() => handlePreviousOrNext('next')} />
        </div>
    </div>
  )
}
